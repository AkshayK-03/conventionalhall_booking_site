...
<div class="container-fluid">
    <div id="outprint" class="list-group">
        <div class="row">
            <div class="col-4 bg-gradient-dark border">Reference Code:</div>
            <div class="col-8 text-light border"><?= isset($code) ? $code : "N/A" ?></div>
            <div class="col-4 bg-gradient-dark border">Hall:</div>
            <div class="col-8 text-light border"><?= isset($hall) ? $hall : "N/A" ?></div>
            <div class="col-4 bg-gradient-dark border">Services:</div>
            <div class="col-8 text-light border"><?= isset($services) ? $services : "N/A" ?></div>
            <div class="col-4 bg-gradient-dark border">Wedding Schedule:</div>
            <div class="col-8 text-light border"><?= isset($wedding_schedule) ? date("M d, Y h:i A", strtotime($wedding_schedule)) : "N/A" ?></div>
            <div class="col-4 bg-gradient-dark border">Total Guests:</div>
            <div class="col-8 text-light border"><?= isset($total_guests) ? $total_guests : "N/A" ?></div>
            <div class="col-4 bg-gradient-dark border">Status:</div>
            ...
            <div class="col-4 bg-gradient-dark border">Remarks:</div>
    ...
    <div class="text-right">
        ...
        <button class="btn btn-sm btn-flat btn-default bg-gradient-blue" type="button" id="edit_booking"><i class="fa fa-edit"></i> Edit</button>
