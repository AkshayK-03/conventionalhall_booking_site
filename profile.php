        ...
        <div class="card card-outline card-blue rounded-0 shadow">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a class="btn btn-default border-0 bg-gradient-blue btn-flat" href="./?page=manage_account">Update Account</a>
                </div>
            </div>
            <div class="card-body">
