...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-gradient-dark text-light" id="login-nav">
      ...
      <nav class="main-header navbar navbar-expand navbar-light border-0 text-sm" id='top-Nav'>
        ...
        <div class="container">
          <a href="./" class="navbar-brand">
            <img src="./uploads/logo.jpg" alt="Site Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
