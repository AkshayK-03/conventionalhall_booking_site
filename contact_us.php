...
<div class="col-12">
    <div class="row my-5 ">
        ...
        <div class="col-md-7">
            <div class="card rounded-0 card-outline card-blue shadow" >
                <div class="card-body rounded-0">
                    <h2 class="text-center">Message Us</h2>
                    <center><hr class="bg-maroon border-dark w-25 border-2"></center>
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 text-center">
                                <button class="btn custom-bg rounded-pill col-5">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
