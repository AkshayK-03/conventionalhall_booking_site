        ...
        <div class="card card-outline card-blue rounded-0 shadow">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a class="btn custom-bg btn-flat" href="./?page=manage_account">Update Account</a>
                </div>
            </div>
            <div class="card-body">
                <div class="container-fluid">
                    <form id="client-form" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <small class="ml-3 text-dark">New Password</small>
                            </div>
                            <div class="form-group col-md-6">
                            <div class="input-group input-group-sm">
                            ...
                            <small class="ml-3 text-dark">Confirm New Password</small>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <small class="ml-3 text-dark">Image</small>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <small class="ml-3 text-dark">Current Password</small><br>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-8">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                            <button type="submit" class="btn custom-bg">Update Account</button>
                            </div>
                            <!-- /.col -->
                        </div>
                        </form>
