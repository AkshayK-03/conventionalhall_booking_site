	...
	<div class="card card-outline card-blue rounded-0 shadow">
		...
		<div class="card-body">
			...
			<div class="form-group d-flex justify-content-center">
				<img src="../uploads/logo.jpg" alt="" id="cimg" class="img-fluid img-thumbnail">
			</div>
			<div class="form-group">
			...
			<div class="form-group d-flex justify-content-center">
				<img src="../uploads/cover.jpeg" alt="" id="cimg2" class="img-fluid img-thumbnail bg-gradient-dark border-dark">
			</div>
			<fieldset>
