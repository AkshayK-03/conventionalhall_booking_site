...
<div class="container-fluid">
    <div id="outprint" class="list-group">
        <div class="row">
            ...
            <div class="col-4 bg-gradient-dark border">Client Name:</div>
            <div class="col-8 text-dark border"><?= isset($fullname) ? $fullname : "N/A" ?></div>
            <div class="col-4 bg-gradient-dark border">Contact #:</div>
            <div class="col-8 text-dark border"><?= isset($contact) ? $contact : "N/A" ?></div>
            <div class="col-4 bg-gradient-dark border">Address:</div>
