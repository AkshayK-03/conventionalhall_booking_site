        ...
        <?php if($page == "home" || $page == "about_us"): ?>
          <div id="header" class="shadow mb-4">
              <div class="d-flex justify-content-center h-100 w-100 align-items-center flex-column px-3">
                  ...
                  <button class="btn btn-lg btn-default bg-gradient-dark border-0 rounded-pill px-4 w-25" id="book_now">Book Now!</button>
              </div>
          </div>
        <?php endif; ?>
        <!-- Main content -->
  ...
  <div class="modal fade rounded-0" id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn custom-bg" id='submit' onclick="$('#uni_modal form').submit()">Save</button>
