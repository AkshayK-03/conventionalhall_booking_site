...
<body class="hold-transition">
  ...
  <style>
    ...
    body{
      background-image: url("./uploads/cover.jpeg");
  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        <center><img src="../uploads/logo.jpg" alt="" id="logo-img"></center>
      ...
      <div class="d-flex w-100 h-100 justify-content-center align-items-center">
        <div class="card col-lg-12 card-outline card-blue rounded-0 shadow">
          <div class="card-header rounded-0">
            <h4 class="text-dark text-center"><b>Registration</b></h4>
          </div>
            ...
            <form id="register-frm" action="" method="post">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <small class="ml-3 text-dark">First Name</small>
                </div>
                <div class="form-group col-md-6">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <small class="ml-3 text-dark">Gender</small>
                </div>
                <div class="col-md-6">
                  <input type="text" name="contact" id="contact" class="form-control form-control-sm form-control-border" required>
                  <small class="ml-3 text-dark">Contact #</small>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <small class="ml-3 text-dark">Address</small>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <small class="ml-3 text-dark">Email</small>
                </div>
              </div>
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <small class="ml-3 text-dark">Password</small>
                </div>
                <div class="form-group col-md-6">
                  <div class="input-group input-group-sm">
                  ...
                  <small class="ml-3 text-dark">Confirm Password</small>
                </div>
              </div>
              <div class="row">
                <div class="col-8">
                  <a href="<?php echo base_url.'login.php' ?>" class="text-blue">Already have an Account</a>
                </div>
                <!-- /.col -->
                <div class="col-4">
                  <button type="submit" class="btn custom-bg">Create Account</button>
                </div>
                <!-- /.col -->
              </div>
            </form>
